...
#line 74 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
  call assertEqual(ZERO, law % probabilityOf(mu_outs(1), E_outs(2), 11.0_defReal), TOL, &
 & location=SourceLocation( &
 & 'multipleCorrelatedLaws_test.f90', &
 & 74) )
  if (anyExceptions()) return
#line 75 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"

    ! Probability with energy slightly below the range
#line 77 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
  call assertEqual(0.5_defReal, law % probabilityOf(mu_outs(1), E_outs(1), eGrid(1)*0.999_defReal), TOL, &
 & location=SourceLocation( &
 & 'multipleCorrelatedLaws_test.f90', &
 & 77) )
  if (anyExceptions()) return
#line 78 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"

    ! Probability with incident energy a bit above the range
#line 80 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
  call assertEqual(0.5_defReal, law % probabilityOf(mu_outs(2), E_outs(2), eGrid(2)*1.001_defReal), TOL, &
 & location=SourceLocation( &
 & 'multipleCorrelatedLaws_test.f90', &
 & 80) )
  if (anyExceptions()) return
#line 81 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"

    ! Normal enquiry
#line 83 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
  call assertEqual(0.5_defReal, law % probabilityOf(mu_outs(2), E_outs(2), 17.0_defReal), TOL, &
 & location=SourceLocation( &
 & 'multipleCorrelatedLaws_test.f90', &
 & 83) )
  if (anyExceptions()) return
#line 84 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
...
#line 130 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
  call assertGreaterThan(5.02_defReal, Chi, &
 & location=SourceLocation( &
 & 'multipleCorrelatedLaws_test.f90', &
 & 130) )
  if (anyExceptions()) return
#line 131 "/home/mhgk4/SCONE/NuclearData/emissionENDF/correlatedLawENDF/Tests/multipleCorrelatedLaws_test.f90"
