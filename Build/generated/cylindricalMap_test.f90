...
#line 106 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertEqual(RES_IDX, idx, &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 106) )
  if (anyExceptions()) return
#line 107 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
...
#line 134 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertEqual(RES_IDX, idx, &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 134) )
  if (anyExceptions()) return
#line 135 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
...
#line 157 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertEqual(RES_IDX, idx, &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 157) )
  if (anyExceptions()) return
#line 158 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
...
#line 168 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertEqual(10, this % map_3d % bins(1),'1st Dimension', &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 168) )
  if (anyExceptions()) return
#line 169 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
#line 169 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
 ...
 & 169) )
  if (anyExceptions()) return
#line 170 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
#line 170 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
 ...
 & 170) )
  if (anyExceptions()) return
#line 171 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
#line 171 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
 ...
 & 171) )
  if (anyExceptions()) return
#line 172 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
#line 172 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
 ...
 & 172) )
  if (anyExceptions()) return
#line 173 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
#line 173 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
 ...
 & 173) )
  if (anyExceptions()) return
#line 174 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"

    ! Get dimensionality
#line 176 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertEqual(3, this % map_unstruct % dimensions(), &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 176) )
  if (anyExceptions()) return
#line 177 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
...
#line 192 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertTrue(out % isValid(),'Radial map case', &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 192) )
  if (anyExceptions()) return
#line 193 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
    call out % reset()

    call this % map_unstruct % print(out)
#line 196 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertTrue(out % isValid(),'Unstruct map case', &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 196) )
  if (anyExceptions()) return
#line 197 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
    call out % reset()

    call this % map_3d % print(out)
#line 200 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
  call assertTrue(out % isValid(),'3d map case', &
 & location=SourceLocation( &
 & 'cylindricalMap_test.f90', &
 & 200) )
  if (anyExceptions()) return
#line 201 "/home/mhgk4/SCONE/Tallies/TallyMaps/Tests/cylindricalMap_test.f90"
    call out % reset()
