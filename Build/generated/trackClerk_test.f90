...
#line 221 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"
  call assertEqual(this % results(i), res, TOL, case // 'BIN : ' //numToChar(i) , &
 & location=SourceLocation( &
 & 'trackClerk_test.f90', &
 & 221) )
  if (anyExceptions()) return
#line 222 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"
    end do

    ! Verify that size of memory returned is correct
#line 225 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"
  call assertEqual(size(this % bins), clerk % getSize(), case // 'Memory size test:', &
 & location=SourceLocation( &
 & 'trackClerk_test.f90', &
 & 225) )
  if (anyExceptions()) return
#line 226 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"

    ! Verify that output calls are correct
    call outF % init('dummyPrinter', fatalErrors = .false.)
    call clerk % print (outF, mem)

#line 231 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"
  call assertTrue(outF % isValid(), case, &
 & location=SourceLocation( &
 & 'trackClerk_test.f90', &
 & 231) )
  if (anyExceptions()) return
#line 232 "/home/mhgk4/SCONE/Tallies/TallyClerks/Tests/trackClerk_test.f90"
