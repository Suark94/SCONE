...
!@Before
  subroutine set_up()
    ...
    ! Checks fills
    ! Size
#line 71 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual(5, size(fills % uni), &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 71) )
  if (anyExceptions()) return
#line 72 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"

    ! Fills in lattice universe
    idx = unis % getIdx(10)
    idx2 = unis % getIdx(2)
    idx20 = unis % getIdx(20)
#line 77 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual([-idx2, -idx2, -idx20, -idx2, 3], fills % uni(idx) % fill , &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 77) )
  if (anyExceptions()) return
#line 78 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
...
!@Test
  subroutine test_get()
    ...
    idx = unis % getIdx(10)
    ptr => unis % getPtr(idx)
#line 105 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual(10, ptr % id(), &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 105) )
  if (anyExceptions()) return
#line 106 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
#line 106 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
 ...
 & 106) )
  if (anyExceptions()) return
#line 107 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"

    ! Universe ID 21 -> With the fast access 
    idx = unis % getIdx(21)
    ptr => unis % getPtr_fast(idx)
#line 111 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual(21, ptr % id(), &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 111) )
  if (anyExceptions()) return
#line 112 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
#line 112 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
 ...
 & 112) )
  if (anyExceptions()) return
#line 113 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"

    ! Universe ID 1
    idx = unis % getIdx(1)
    ptr => unis % getPtr(idx)
#line 117 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual(1, ptr % id(), &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 117) )
  if (anyExceptions()) return
#line 118 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
#line 118 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
 ...
 & 118) )
  if (anyExceptions()) return
#line 119 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"

    ! Test size
#line 121 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
  call assertEqual(5, unis % getSize(), &
 & location=SourceLocation( &
 & 'universeShelf_test.f90', &
 & 121) )
  if (anyExceptions()) return
#line 122 "/home/mhgk4/SCONE/Geometry/Universes/Tests/universeShelf_test.f90"
